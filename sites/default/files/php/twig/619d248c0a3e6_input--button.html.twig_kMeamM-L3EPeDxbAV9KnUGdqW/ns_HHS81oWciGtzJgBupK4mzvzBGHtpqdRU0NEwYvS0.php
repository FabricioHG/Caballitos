...
class __TwigTemplate_7ce74c366c0e4aa21a548e7ae596f18208dda9b2e0e82eda989ac011ec6aada3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/drudg8b3/templates/input--button.html.twig", "/datos/www/webdrupal8-9/themes/drudg8b3/templates/input--button.html.twig");
    }
