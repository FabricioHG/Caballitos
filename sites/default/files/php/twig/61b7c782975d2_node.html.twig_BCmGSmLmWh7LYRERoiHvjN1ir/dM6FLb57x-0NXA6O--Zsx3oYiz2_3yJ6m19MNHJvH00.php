...
class __TwigTemplate_41d46b4266b0d830d0f64c9ed5b1358755d053618436c2f2a55b550429a65a6b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 74, $this->source))) : ("")), 5 => "clearfix"];
        // line 78
        echo "<div";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method", false, false, true, 78), "removeAttribute", [0 => "role"], "method", false, false, true, 78), 78, $this->source), "html", null, true);
        echo ">
...
";
    ...
    {
        return new Source("", "themes/drudg8b3/templates/node.html.twig", "/datos/www/webdrupal8-9/themes/drudg8b3/templates/node.html.twig");
    }
